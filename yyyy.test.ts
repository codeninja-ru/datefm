...
describe('yyyy', () => {
    test('format two digit year', () => {
        ...
        expect(formatter(new Date('11/10/0001 10:10:10 UTC'))).toEqual('0001');
        expect(formatter(new Date('11/10/0111 10:10:10 UTC'))).toEqual('0111');
        expect(formatter(new Date('11/10/0011 10:10:10 UTC'))).toEqual('0011');
    });
